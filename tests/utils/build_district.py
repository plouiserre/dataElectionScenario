...
def build_first_district():
    ...
    first_district = __construct_district('2ème circonscription', '2902', '78185', '55066', first_candidate_first_district, 
...
def build_second_district():
    ...
    second_district = __construct_district('6ème circonscription', '4506', '76104', '52335', first_candidate_second_district, 
...
def build_third_district():
    ...
    third_district = __construct_district('6ème circonscription', '6706', '98281', '67852', first_candidate_third_district,
                                                second_candidate_third_district, None)
    return third_district

def __construct_district(label, number, registered, voting, first_candidate, second_candidate, third_candidate): 
        district = District()
